...
public class CreateTaskPanel extends javax.swing.JPanel {
    ...
    java.util.ArrayList<TaskPanel> tasks;
    /**
     * Creates new form NewTaskPanel
     */
    public CreateTaskPanel(javax.swing.JPanel addHere, java.util.ArrayList<TaskPanel> t) {
    ...
    private void initComponents() {
        ...
        createTask.setFont(new java.awt.Font("Helvetica Neue", 0, 13)); // NOI18N
        ...
        cancel.setFont(new java.awt.Font("Helvetica Neue", 0, 13)); // NOI18N
        ...
        taskName.setFont(new java.awt.Font("Helvetica Neue", 0, 13)); // NOI18N
        ...
        taskDetails.setFont(new java.awt.Font("Helvetica Neue", 0, 13)); // NOI18N
        ...
        priorityBox.setFont(new java.awt.Font("Helvetica Neue", 0, 13)); // NOI18N
        ...
        completionDate.setFont(new java.awt.Font("Helvetica Neue", 0, 13)); // NOI18N
    ...
    private void createTaskActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        TaskPanel t = new TaskPanel(name,details,urgency,categoryNum,parentContainer);
    ...
    private void categoryBoxActionPerformed(java.awt.event.ActionEvent evt) {
        if(categoryBox.getSelectedIndex() == 0){
            ...
            jPanel1.setBackground(new Color(findCategory(categoryBox.getSelectedIndex())));
        }
